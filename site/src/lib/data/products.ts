...
export const products: Product[] = [
	...
	},
	{
		...
		fullDescription:
			'ストックレーダーは、トイレットペーパーや洗剤といった家の消耗品を切らさないためのアプリです。在庫を数えて記録するのではなく、「買った」を1タップ押すだけ。購入の間隔から、そろそろ切れそうなタイミングをそっと予知して教えます。\n\n通知・ウィジェット・音声で「今どれが切れかけか」がすぐわかるので、アプリを開く必要すらありません。買い物前チェックで、買うもの・買わなくていいもの（最近買ったもの）を分けて見られるので、二重買いも防げます。\n\nソロ利用は全機能無料。パートナーと同じ在庫リストを共有したいときだけ「ふたりプラン」をどうぞ。氏名やメールアドレスは保存せず、あなたの世帯だけのデータとして、いつでも書き出し・削除できます。',
		type: 'app',
		status: 'development',
		platforms: ['ios'],
		links: {},
		...
		privacy: {
			...
			thirdPartyServices: [
				...
				'Cloudflare Workers / D1（データ保存・世帯同期）',
			...
			faq: [
				{
					...
					answer:
						'ソロ利用（アイテム登録・切れかけ予知・1タップ記録・通知・ウィジェット・音声・買い物前チェック）は全機能無料です。パートナーと在庫リストを共有する「ふたりプラン」だけが有料です。'
				},
				{
					question: 'ふたりプランとは？',
					answer:
				...
				},
				{
					question: 'アカウントやデータを削除するには？',
					answer:
						'アカウント画面の「アカウントを削除」から、世帯データを含めて完全に削除できます。この操作は取り消せません。同じ画面から CSV での書き出しもできます。'
				}
			],
			systemRequirements: 'iOS 17.0以上'
		}
